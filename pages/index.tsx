...
export default function Home() {
  ...
  const { orders, fetchOrders, addToOrder, removeOrder, saveTransaction } =
    useOrders()
        ...
        <div className="mt-16 w-1/3 p-4">
          ...
          <ul className="mt-2 h-[668px] overflow-auto space-y-3">
            {orders.map(order => (
              <li
                ...
                className="border-b border-black py-4 pr-3 flex justify-between items-center"
              >
                ...
                <div className="flex gap-x-4 items-center">
                  ...
                  <span
                    ...
                    className="rounded-md py-2 px-3 text-xs text-white bg-red-600"
                  >
                    X
                  </span>
                </div>
          ...
          <div className="">
            ...
            <button
              ...
              className="bg-teal-600 p-3 rounded-md text-white w-full"
            >
              Bayar Sekarang
            </button>
          </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-[400px] p-6 rounded-lg shadow-xl transition-transform transform hover:scale-105">
            <h2 className="text-2xl mb-5 font-semibold text-teal-600">
